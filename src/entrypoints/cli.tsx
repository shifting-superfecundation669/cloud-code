...
// ---- Auto-load OpenAI-compatible API config from ~/.claude.json ----
// Same pattern as CLAUDE_CODE_USE_BEDROCK: set process.env early so all
// downstream code (isUsing3PServices, getAPIProvider, getAnthropicClient)
// sees the env vars exactly as if the user had exported them manually.
